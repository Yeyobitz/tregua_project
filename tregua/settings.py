"""
Django settings for tregua project.
...
SECRET_KEY = 'django-insecure-wc&!cjsx5)taxhaaxta9kf*v0fvuxbi(4m--)(ku-%ry&5&%nc'
...
WSGI_APPLICATION = 'tregua.wsgi.application'
